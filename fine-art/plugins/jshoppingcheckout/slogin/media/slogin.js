...
var SLoginPlugin = SLoginPlugin || {

    initialize:function () {
        var block = document.getElementById('plg-slogin-buttons');
        ...
        for (var i = 0; i < elements.length; i++) {
            elements[i].onclick = function (e) {
                ...
                var size = SLoginPlugin.getPopUpSize(el[0].className);
                var win_size = SLoginPlugin.WindowSize();
...
SLoginPlugin.addListener(window, 'load', function () {
    SLoginPlugin.initialize();
});